...
Fwiffo <http://forum.kerbalspaceprogram.com/index.php?/profile/148084-fwiffo/>
v0.7.7-14-Fwiffo2, May 2016:
...
********************************************************
*                                                      *
*  This is an UNOFFICIAL "alpha" development release!  *
*                                                      *
*  Use at your own risk and do not bug Elián or Fwiffo *
...
* KSP version 1.1, 1.1.1 or 1.1.2 (and maybe above)
...
********************************************************
*                                                      *
*  NOTE: If a previous version of RCS Build Aid was    *
*  installed, you should move your settings.cfg from:  *
*                                                      *
*      GameData/RCSBuildAid                            *
*                                                      *
*  to:                                                 *
*                                                      *
*      GameData/RCSBuildAid/Plugins/PluginData         *
*                                                      *
********************************************************
